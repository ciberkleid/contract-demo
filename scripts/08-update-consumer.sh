...
cp ${CONTRACT_DEMO_HOME}/contract-demo-setup/artifacts/simple-consumer/src/main/java/com/example/simpleconsumer/fortune/FortuneService-delta1.java ${CONTRACT_DEMO_HOME}/simple-consumer/src/main/java/com/example/simpleconsumer/fortune/FortuneService.java
