...
cp ${CONTRACT_DEMO_WORKSPACE}/contract-demo-setup/artifacts/simple-producer/src/main/java/com/example/simpleproducer/fortune/FortuneController-delta2.java ${CONTRACT_DEMO_WORKSPACE}/simple-producer/src/main/java/com/example/simpleproducer/fortune/FortuneController.java
cp ${CONTRACT_DEMO_WORKSPACE}/contract-demo-setup/artifacts/simple-producer/pom-delta2.xml ${CONTRACT_DEMO_WORKSPACE}/simple-producer/pom.xml
