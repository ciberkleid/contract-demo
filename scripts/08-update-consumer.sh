...
cp ${CONTRACT_DEMO_ARTIFACTS}/simple-consumer/src/main/java/com/example/simpleconsumer/fortune/FortuneService-delta1.java ${CONTRACT_DEMO_WORKSPACE}/simple-consumer/src/main/java/com/example/simpleconsumer/fortune/FortuneService.java
