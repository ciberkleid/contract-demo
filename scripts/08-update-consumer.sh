...
cp ${CONTRACT_DEMO_WORKSPACE}/contract-demo-setup/artifacts/simple-consumer/src/main/java/com/example/simpleconsumer/fortune/FortuneService-delta1.java ${CONTRACT_DEMO_WORKSPACE}/simple-consumer/src/main/java/com/example/simpleconsumer/fortune/FortuneService.java

echo ""
echo "SUCCESS: simple-consumer is ready to test against updated contract-based stub"
